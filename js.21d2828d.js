...
},{"./gsap-core.js":"TNS6","./CSSPlugin.js":"bp4Z"}],"MuPq":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.vertexShader = exports.store = exports.loader = exports.fragmentShader = exports.backgroundCoverUv = void 0;
var _window = window,
  THREE = _window.THREE;
...
var _window = window,
  THREE = _window.THREE;
var ww = _constants.store.ww,
  wh = _constants.store.wh;
var Gl = /*#__PURE__*/function () {
  function Gl() {
    _classCallCheck(this, Gl);
    this.scene = new THREE.Scene();
    this.camera = new THREE.OrthographicCamera(ww / -2, ww / 2, wh / 2, wh / -2, 1, 10);
...
var gl = new Gl();
var _default = exports.default = gl;
},{"./constants":"MuPq"}],"urGT":[function(require,module,exports) {
"use strict";
...
var ww = _constants.store.ww,
  wh = _constants.store.wh;
var GlObject = /*#__PURE__*/function (_THREE$Object3D) {
  function GlObject() {
    _classCallCheck(this, GlObject);
    return _callSuper(this, GlObject, arguments);
  }
  _inherits(GlObject, _THREE$Object3D);
  return _createClass(GlObject, [{
    key: "init",
...
var _default = exports.default = GlObject;
},{"./constants":"MuPq"}],"Hn2w":[function(require,module,exports) {
"use strict";
...
var _window = window,
  THREE = _window.THREE;
var PLANE_GEO = new THREE.PlaneBufferGeometry(1, 1, 32, 32);
var PLANE_MAT = new THREE.ShaderMaterial({
  transparent: true,
  fragmentShader: _constants.fragmentShader,
  vertexShader: _constants.vertexShader
});
var Plane = /*#__PURE__*/function (_GlObject) {
  function Plane() {
    _classCallCheck(this, Plane);
    return _callSuper(this, Plane, arguments);
  }
  ...
  return _createClass(Plane, [{
    ...
    value: function init(el) {
      var _this = this;
      _superPropGet(Plane, "init", this, 3)([el]);
      this.geo = PLANE_GEO;
      ...
      this.texture = _constants.loader.load(this.img.src, function (texture) {
        texture.minFilter = THREE.LinearFilter;
        texture.generateMipmaps = false;
        _this.mat.uniforms.uTexture.value = texture;
        _this.mat.uniforms.uImageSize.value = [_this.img.naturalWidth, _this.img.naturalHeight];
      });
      this.mesh = new THREE.Mesh(this.geo, this.mat);
      this.mesh.scale.set(this.rect.width, this.rect.height, 1);
      this.add(this.mesh);
      _Gl.default.scene.add(this);
    }
  }]);
}(_GlObject2.default);
var _default = exports.default = Plane;
},{"./GlObject":"urGT","./constants":"MuPq","./Gl":"kEky"}],"Gf2G":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var isDevice = _constants.store.isDevice,
  ww = _constants.store.ww;
var usePosition = function usePosition(_ref) {
...
var useIsVisible = function useIsVisible(_ref2, _ref3) {
  var left = _ref2.left,
    right = _ref2.right,
    width = _ref2.width,
    min = _ref2.min,
  ...
  var state = _ref3.state,
    opts = _ref3.opts;
  var currentRounded = state.currentRounded;
  var threshold = opts.threshold;
  var translate = _gsap.default.utils.wrap(min, max, currentRounded);
  var start = left + translate;
  var end = right + translate;
  return {
    translate: translate,
    isVisible: start < threshold + ww && end > -threshold,
    progress: _gsap.default.utils.clamp(0, 1, 1 - (translate + left + width) / (ww + width))
  };
};
var Slider = /*#__PURE__*/function () {
  ...
  return _createClass(Slider, [{
    ...
    key: "init",
    value: function init() {
      return _gsap.default.utils.pipe(this.setup(), this.on());
    }
  }, {
    key: "destroy",
    ...
    value: function off() {
      var _this$events2 = this.events,
        move = _this$events2.move,
        up = _this$events2.up,
        down = _this$events2.down;
    ...
    value: function setup() {
      ...
      var _this$el$getBoundingC = this.el.getBoundingClientRect(),
        wrapWidth = _this$el$getBoundingC.width,
        wrapDiff = _this$el$getBoundingC.left;
      ...
      // Cache stuff
      Array.from(items).reduce(function (all, el) {
    ...
    value: function calc() {
      ...
      state.progress = _gsap.default.utils.wrap(0, 1, state.currentRounded / state.max);
    ...
    value: function transformItems() {
      ...
      var _this$items = this.items,
        items = _this$items === void 0 ? [] : _this$items,
        state = this.state,
        opts = this.opts;
      var flags = state.flags;
      items.forEach(function (_, i) {
        var item = _this2.items[i];
        var _useIsVisible = useIsVisible(item, {
            state: state,
            opts: opts
          }),
          translate = _useIsVisible.translate,
          isVisible = _useIsVisible.isVisible,
          progress = _useIsVisible.progress;
        item.plane.updateX(translate);
        item.plane.mat.uniforms.uVelo.value = _this2.state.diff;
        if (!item.out && item.tl) {
    ...
    value: function onDown(e) {
      var _usePosition = usePosition(e),
        x = _usePosition.x,
        y = _usePosition.y;
    ...
    value: function onMove(e) {
      var _usePosition2 = usePosition(e),
        x = _usePosition2.x,
        y = _usePosition2.y;
      var state = this.state;
...
},{"gsap":"TpQl","./constants":"MuPq","./Plane":"Hn2w"}],"QvaY":[function(require,module,exports) {
"use strict";
...
var slider = new _Slider.default(document.querySelector("#js-slider"));
_gsap.default.ticker.add(function () {
  _Gl.default.render();
  slider.render();
});
},{"gsap":"TpQl","./Gl":"kEky","./Slider":"Gf2G"}]},{},["QvaY"], null)
//# sourceMappingURL=js.21d2828d.js.map